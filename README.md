The project does: Chromagram mainly used for music application. Here, we are demonstrating to apply on non-musical application like sound detection of drone vs. noise
